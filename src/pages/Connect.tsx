...
offer:
    0:
        itemType:
            2
        token:
            0xD0E0f719C72Ff82957957890435687F2444ef28f
...
salt:
24446860302761739304752683030156737591518664810215442929807093780685310352753
conduitKey:
...
*/
    ...
    return (
        <div>
            ...
            <div>
                <button type="button" onClick={buy}>transact</button>
            </div>
        </div>
    );
}
